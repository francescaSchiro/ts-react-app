...
const FooterBottomInfo = () => (
    <Wrapper>
        <FooterBottomInfoItem style={{ textTransform: 'uppercase', paddingBottom: '5px' }}>IL GIOCO é VIETATO AI MINORI E PUò CAUSARE DIPENDENZA PATOLOGICA</FooterBottomInfoItem>
