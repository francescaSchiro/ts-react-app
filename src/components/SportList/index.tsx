...
const SportList = () => (
  <SportListWrapper>
    <SportListSections>
      ...
      <SportListSection>
        <SportListIcon active={false} > {sportListItems[3].iconText()}</SportListIcon>
        <SportListLabel active={false}> OGGI </SportListLabel>
      </SportListSection>
      <SportListSection>
        <SportListIcon active={false}>{sportListItems[4].iconText()}</SportListIcon>
        <SportListLabel active={false}> DOMANI </SportListLabel>
      </SportListSection>
      <SportListSection>
        <SportListIcon active={false}>{sportListItems[5].iconText()}</SportListIcon>
